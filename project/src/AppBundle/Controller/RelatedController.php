...
abstract class RelatedController extends Controller
{
    /**
     ...
     */
    protected function handleValidForm(Related $entity)
    {
     ...
     * @return RedirectResponse|Response
     */
    private function createAndHandleForm(Related $entity, $request, $action, $options = array())
    {
